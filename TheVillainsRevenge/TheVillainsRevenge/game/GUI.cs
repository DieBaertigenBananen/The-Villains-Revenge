...
namespace TheVillainsRevenge
{
    class GUI
    {
        ...
        {
            //Itemslot hinten
            spriteBatch.Draw(Texture, new Vector2(45, 10), new Rectangle(0, 112, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
            switch (sitem2)
            {
                case 1:
                    spriteBatch.Draw(Texture, new Vector2(45 + 9, 18), new Rectangle(64, 112, 48, 48), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
            }            
            //Itemslot vorne
            spriteBatch.Draw(Texture, new Vector2(30, 10), new Rectangle(0, 112, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
            switch (sitem1)
            {
                case 1:
                    spriteBatch.Draw(Texture, new Vector2(30 + 9, 18), new Rectangle(64, 112, 48, 48), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
            }
            //Leben
            switch (leben)
            {
                case 4:
                    spriteBatch.Draw(Texture, new Vector2(10, 10), new Rectangle(0, 0, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
                case 3:
                    spriteBatch.Draw(Texture, new Vector2(10, 10), new Rectangle(64, 0, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
                case 2:
                    spriteBatch.Draw(Texture, new Vector2(10, 10), new Rectangle(128, 0, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
                case 1:
                    spriteBatch.Draw(Texture, new Vector2(10, 10), new Rectangle(192, 0, 64, 64), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
                    break;
            }
