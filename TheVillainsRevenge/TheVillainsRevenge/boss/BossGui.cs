...
namespace TheVillainsRevenge
{
    class BossGUI : GUI
    {
        ...
        public void Draw(SpriteBatch spriteBatch, int leben, int bossleben)
        {
            ...
            spriteBatch.Draw(BossHealth, new Vector2((Game1.resolution.X / 2) - 500,92), new Rectangle(0, 0, 917 / 100 * bossleben, 53), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
            spriteBatch.Draw(BossBar, new Vector2((Game1.resolution.X / 2) - 579, -1), new Rectangle(0, 0, 1075, 200), Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
        }
    }
}
